...
public class Server {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Get public key
			byte[] publickeyServerBytes = Files.readAllBytes(new File("F:\\NS Project\\publickey_amazon_server.txt").toPath());
			...
			// Get private key
			byte[] privatekeyBytes = Files.readAllBytes(new File("F:\\NS Project\\privatekey_amazon_server.txt").toPath());
			...
			while (true) {
				...
				c = Cipher.getInstance("AES");
				productlist = readCSV("F:\\NS Project\\products\\productlist_amazon.csv");
				...
				if (product_ID.equals("1")) {
					product = readFile("F:\\NS Project\\products\\product1_amazon.txt");

				}
				if (product_ID.equals("2")) {
					product = readFile("F:\\NS Project\\products\\product2_amazon.txt");

				}
				if (product_ID.equals("3")) {
					product = readFile("F:\\NS Project\\products\\product3_amazon.txt");

				}
				if (product_ID.equals("4")) {
					product = readFile("F:\\NS Project\\products\\product4_amazon.txt");
